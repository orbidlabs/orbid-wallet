...
async function main() {
    ...
    console.log("Deploying OrbIdSwapRelay V2...");
    ...
    console.log("\n========================================");
    console.log("OrbIdSwapRelay V2 deployed to:", address);
    console.log("========================================");
    console.log("\nSupports: Uniswap V2, V3, and V4");
    console.log("\nUpdate src/lib/uniswap/config.ts with:");
    console.log(`export const ORBID_SWAP_RELAY_ADDRESS = '${address}';`);
    console.log("\nTo verify on WorldScan:");
    console.log(`npx hardhat verify --network worldchain ${address} ${PERMIT2} ${SWAP_ROUTER_V2} ${SWAP_ROUTER_V3} ${UNIVERSAL_ROUTER_V4} ${FEE_RECIPIENT}`);
}

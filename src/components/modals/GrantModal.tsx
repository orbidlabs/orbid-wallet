            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                >
                    ...
                    <div className="p-4 border-b border-white/5 flex items-center justify-between">
                        <h2 className="text-lg font-bold text-white">Worldcoin Grants</h2>
                    ...
                    <div className="p-6">
                        {loading ? (
                            ...
                            <div className="text-center py-8">
                                <p className="text-red-400 mb-2">Failed to load grant info</p>
                                <button
                                    onClick={onClose}
                                    className="px-4 py-2 bg-zinc-800 rounded-xl text-sm font-medium hover:bg-zinc-700 transition-colors"
                                >
                                    Close
                                </button>
                            </div>
        ...
        <div className="flex flex-col items-center text-center gap-6">
            ...
            <div>
                <h3 className="text-xl font-bold text-white mb-2">
                    {isAvailable ? 'Grant Available!' : 'Next Grant'}
                </h3>
                <p className="text-zinc-400 text-sm">
                    {isAvailable
                        ? 'You have a Worldcoin grant ready to claim.'
                        : `Your next grant will be available on ${startDate.toLocaleDateString()}`}
                </p>
            </div>
